    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
      ...
      >
        ...
        <input
          ...
          className="flex-1 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none focus:border-brand-400 focus:bg-white focus:ring-2 focus:ring-brand-100 transition"
        />
        <button
          type="submit"
