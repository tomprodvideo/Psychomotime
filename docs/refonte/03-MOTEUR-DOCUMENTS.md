...
| 5 | ~~**Écrit pour un tiers non soignant**~~ **fait le 2026-09-13** | enseignant, organisme évaluateur | UN objet, TROIS usages déclarés, et l'usage commande ce qui est exclu par défaut. **Le consentement DÉCIDE ici** : la présomption de `L1110-4` disparaît hors équipe de soins, donc refuser n'ajoute aucune condition. Trois états — accord, dérogation motivée et journalisée à part, refus FERME sur un retrait. **Destinataire n'est pas destination** : « remis à la personne, qui transmettra » ne nomme personne, et le document dit que le cabinet n'a rien adressé. Rien n'y figure par défaut. |
...
| D-t | **Le refus ferme sur un accord RETIRÉ** (rang 5). Aucune dérogation possible : un logiciel où émettre contre un retrait coûte aussi peu qu'émettre avec un accord rend le retrait sans effet, alors que c'est le cabinet qui l'a enregistré. **Réversible** : retirer la garde ne détruit aucune donnée. [E-14] | psychomotricienne | non |
| D-u | **Exiger un accord avant de remettre à un tiers non soignant** — `D-i` inversé pour ce rang, sur l'argument que la présomption de `L1110-4` n'existe pas hors équipe de soins. [SOURCE — à vérifier ; la qualification d'un destinataire donné est le travail d'un juriste.] [E-13] | juriste/DPO | non |
| D-v | La formulation des titres imprimés et de la mention de cadre du rang 5, qui empêche ce document d'être lu comme une pièce officielle. [E-02] | psychomotricienne | non |
